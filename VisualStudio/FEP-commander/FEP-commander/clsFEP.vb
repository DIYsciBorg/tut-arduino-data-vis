...
Public Class clsFEP
    ...
    Const cngroup = "F0"
    Const cntxmode = "F0"
    Const cnchannelmode = "01"
    Const cnchannel2 = "18"
    Const cnchannel3 = "1C"
    Const cnretransmit = "00"
    Const cnroamingthresh = "50"
    Const cnpacketresponse = "81"
    Const cnunused = "00"
    Const cncmdinterval = "01"
    Const cnbandswitching = "00"
    Const cnbuffertime = "64"
    Const cnaddresscheck = "8D"
    Const cnbeaconmode = "00"
    Const cnuart = "03"
    Const cnpowermode = "09"
    Const cnstandby = "0F"
    Const cncrlf = "10"
    Const cntxmodedelimiter = "C1"
    Const cnsleeptime = "0F"
    Const cndatatimeout = "01"
    Const cnrepeateraddr1 = "FF"
    Const cnrepeateraddr2 = "FF"
    ...
    Private Sub applyConstants()
        group = cngroup
        txmode = cntxmode
        channelmode = cnchannelmode
        channel2 = cnchannel2
        channel3 = cnchannel3
        retransmit = cnretransmit
        roamingthresh = cnroamingthresh
        packetresponse = cnpacketresponse
        unused = cnunused
        cmdinterval = cncmdinterval
        bandswitching = cnbandswitching
        buffertime = cnbuffertime
        addresscheck = cnaddresscheck
        beaconmode = cnbeaconmode
        uart = cnuart
        powermode = cnpowermode
        standby = cnstandby
        crlf = cncrlf
        txmodedelimiter = txmodedelimiter
        sleeptime = cnsleeptime
        datatimeout = cndatatimeout
        repeateraddr1 = cnrepeateraddr1
        repeateraddr2 = cnrepeateraddr2
    End Sub
    ...
    ' Methods are actions the class can take (it is the meat of our code)
