...
#define SENSORS 12      // Number of analog sensors, from A0 to A11 (1-12 sensors)
#define SAMPLES 5    // Number of samples per pin to average
#define ISD 1       // Inter-Sample delay: delay between each sample. Generally set to 0
#define RSD 1     // Reporting Sample delay: between each cycle. Generally set to 0
